...
```code
java -cp java-decompiler.jar  org.jetbrains.java.decompiler.main.decompiler.ConsoleDecompiler src/dremio-ce-sabot-kernel-23.1.0-202211250136090978-a79618c7.jar dest
```